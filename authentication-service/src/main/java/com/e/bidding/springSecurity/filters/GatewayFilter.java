...
import com.e.bidding.springSecurity.config.GatewayPublicKeyManager;
...
public class GatewayFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (path.equals("/validate-role") || path.equals("/auth/v1/login") ||
                path.equals("/auth/v1/register") || path.equals("/refresh-token")) {
        ...
        try {
            ...
            if (Math.abs(now - requestTimestamp) > 30_000) { // 30 seconds tolerance
                ...
                System.out.println("path from gateway: " + path);
            String metadata = timestamp + "|" + nonce + "|" + path;
